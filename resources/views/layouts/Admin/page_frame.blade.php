...
@section('css')
    ...
    <link rel="stylesheet" href="{{assets('plugins/slidebars.css')}}">
    <link rel="stylesheet" href="{{assets('plugins/style-responsive.css')}}">
        ...
        <header class="header white-bg">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar"
                                                             src="{{assets('imgs/frame_imgs/avatar-mini.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar"
                                                             src="{{assets('imgs/frame_imgs/avatar-mini2.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar"
                                                             src="{{assets('imgs/frame_imgs/avatar-mini3.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar"
                                                             src="{{assets('imgs/frame_imgs/avatar-mini4.jpg')}}"></span>
                                    <span class="subject">
            ...
            <div class="top-nav ">
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="{{assets('imgs/frame_imgs/avatar1_small.jpg')}}">
...
@section('tail_js')
    @parent
    <script src="{{assets('plugins/sparkline-chart.js')}}"></script>
    <script src="{{assets('plugins/easy-pie-chart.js')}}"></script>
    <script src="{{assets('plugins/count.js')}}"></script>
